    ...
    this.go = function(e, q) {
        ...
        if (b) {
            if (!d) {
                ...
                d = h(d + d).css({"z-index": 8, position: "absolute", width: "100%", height: "100%", left: 0, top: 0, visibility: "hidden"}).appendTo(c)
            }
            t = g(u, 30, d.get(0))
        }
        if (b && t) {
...
;
jQuery("#wowslider-container1").wowSlider({effect: "blur", prev: "", next: "", duration: 20 * 100, delay: 20 * 100, width: 1500, height: 550, autoPlay: true, stopOnHover: false, loop: false, bullets: 0, caption: false, captionEffect: "slide", controls: false, onBeforeStep: 0, images: 0});